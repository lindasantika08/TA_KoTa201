    ...
    computed: {
        ...
        groupedAnswers() {
            ...
            this.filteredAnswers.forEach((answer) => {
                ...
                // For unsubmitted assessments, we don't need to add qaItems
                // The unsubmitted status will trigger the appropriate UI
                if (
                    answer.status !== "unsubmitted" ||
                    groupMap.get(key).qaItems.length === 0
                ) {
