    ...
    <div class="flex-1">
      ...
      <main class="p-6">
        <div class="mb-6">
          ...
          <h1 class="text-2xl font-bold text-gray-800 mt-4">Project Report Dashboard</h1>
        </div>
        ...
        <Card title="My Projects" class="bg-white shadow-lg">
          ...
          <div v-else class="grid gap-6">
            <div
              ...
              class="bg-white border rounded-lg p-6 hover:shadow-lg transition-all duration-200 cursor-pointer"
            >
