...
<template>
    <div class="min-h-screen flex bg-gray-50">
        <!-- Left Section -->
        <div
            class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-sky-100 to-sky-100 p-12 relative"
        >
        ...
        <!-- Right Section -->
        <div
            class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12"
        >
