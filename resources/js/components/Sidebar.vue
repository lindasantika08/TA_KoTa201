                ...
                <li>
                    <button
                        ...
                        :class="{
                            'bg-white':
                                isActive(
                                    '/sispa/dosen/assessment/projectsSelf'
                                ) ||
                                isActive(
                                    '/sispa/dosen/assessment/projectsPeer'
                                ),
                        }"
...
export default {
    ...
    data() {
        return {
            isAssessmentOpen:
                ...
                this.isActive("/sispa/dosen/assessment/projects-reflective"),
            isKelolaProyekOpen:
    ...
    methods: {
        ...
        goToReflectiveAssessment() {
            router.visit("/sispa/dosen/assessment/projects-reflective");
        },
        isActive(route) {
