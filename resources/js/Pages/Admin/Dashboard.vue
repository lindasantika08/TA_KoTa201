...
export default {
    ...
    setup(props) {
        const totalActiveProjects = computed(() => {
            return props.majorsData.reduce(
                (total, major) => total + major.activeProjects,
                0
            );
        });
        ...
        const totalInactiveProjects = computed(() => {
            return props.majorsData.reduce(
                (total, major) => total + major.inactiveProjects,
                0
            );
        });
        ...
        const projectPercentage = computed(() => {
            return (
                (totalActiveProjects.value / totalProjects.value) *
                100
            ).toFixed(1);
        });
                ...
                >
                    <div>
                        ...
                        <p class="text-gray-500">
                            Pantau semua jurusan dan proyek dalam satu tempat
                        </p>
                    </div>
                </div>
                    ...
                    >
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span
                                    class="text-green-600 font-semibold px-3 py-1 bg-green-100 rounded-full"
                                >
                                    {{ major.activeProjects }}
                                </span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600"
                                    >Proyek Non-Aktif:</span
                                >
                                <span
                                    class="text-red-600 font-semibold px-3 py-1 bg-red-100 rounded-full"
                                >
                                    {{ major.inactiveProjects }}
                                </span>
                            </div>
                            ...
                            <div
                                class="w-full bg-blue-600 rounded-full h-2 mt-2"
                            >
                                <div
