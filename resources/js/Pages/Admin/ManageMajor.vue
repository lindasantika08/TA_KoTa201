  ...
  <div class="flex min-h-screen bg-gray-100">
    ...
    <div class="flex-1">
      ...
      <main class="p-6">
        ...
        <div class="mb-6">
          <h1 class="text-3xl font-bold text-gray-800">Majors Management</h1>
          ...
          <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
            <div class="flex items-center">
              ...
              <div>
                ...
                <p class="text-2xl font-bold text-gray-800">{{majors.reduce((sum, major) => sum + major.student_count,
                  0) }}</p>
              </div>
            </div>
          </div>
        ...
        <Card title="Major List" class="bg-white">
          ...
          <div v-if="isLoading" class="flex justify-center items-center p-8">
            <font-awesome-icon :icon="['fas', 'spinner']" class="text-blue-600 text-2xl animate-spin" />
          </div>

          <div v-else-if="filteredMajors && filteredMajors.length">
            <div class="flex justify-between items-center mb-4 px-4">
              <div v-if="searchQuery" class="text-sm text-gray-600">
                Found {{ filteredMajors.length }} result(s) for "{{ searchQuery }}"
              </div>
        ...
        <div v-if="showModal" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
          <div class="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <input v-model="newMajor" type="text" placeholder="Enter Major Name"
        ...
        <!-- Edit Major Modal -->
        <div v-if="showModalEdit" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
          <div class="bg-white p-6 rounded-lg shadow-lg w-96">
            <div class="flex justify-between items-center mb-4">
            ...
            <input v-model="editedMajor" type="text" placeholder="Enter Major Name"
              class="w-full p-2 border rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500" />
            <div class="flex justify-end space-x-2">
