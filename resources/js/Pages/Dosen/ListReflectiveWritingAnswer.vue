...
export default {
    ...
    setup() {
        ...
        return {
            ...
            reflective_order: computed(
                () => page.props.reflective_writing_order
            ),
        };
    },
    ...
    methods: {
        async fetchDataAnswer() {
            ...
            try {
                const response = await axios.get(
                    "/sispa/api/get-reflective-writing-answer",
                    {
                        params: {
                            batchYear: this.batch_year,
                            projectName: this.project_name,
                            reflective_writing_order: this.reflective_order,
                        },
                    }
                );
        ...
        viewAnswer(studentId) {
            ...
            router
                .get(
                    "/sispa/api/reflective-assessment-writing-answer-details",
                    {
