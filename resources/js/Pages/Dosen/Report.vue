...
const breadcrumbs = ref([{ text: "Report", href: "/dosen/report" }]);
  ...
  <div class="flex min-h-screen bg-gray-50">
            ...
            >
              <div class="space-y-3">
                ...
                <p class="text-gray-400">
                  Silakan pilih batch year dan project name yang berbeda
                </p>
              </div>
            </div>
                ...
                <div>
                  ...
                  <ul class="space-y-2">
                    ...
                    >
                      ...
                      ></span>
                      {{ member.name }}
                      <span v-if="member.nim" class="ml-1 text-gray-400">
                        ({{ member.nim }})
                      </span>
                    </li>
                  </ul>
    ...
    <div v-if="showModal" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <!-- Modal Content -->
        <div class="relative bg-white rounded-lg max-w-4xl w-full mx-4 p-6">
          <!-- Modal Header -->
            ...
            <div v-else>
              <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <template
                      v-for="(student, index) in modalData.students"
                      :key="student.id"
                    >
                      <!-- Main Student Row -->
                      <tr>
                        ...
                        <td
                          ...
                          :class="getSelisihClass(student.selisih)"
                        >
                          {{ student.selisih }}
                        </td>
                        <td
                          class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center"
                          :class="getNilaiClass(student.nilai_total)"
                        >
                          {{ student.nilai_total }}
                        </td>
                        <td
                        ...
                        >
                          <button
                            @click="toggleDetails(student.id)"
                            class="text-blue-600 hover:text-blue-800"
                          >
                            {{
                              expandedStudents[student.id] ? "Tutup" : "Lihat"
                            }}
                          </button>
                        </td>
                      </tr>
                      <!-- Detailed Scores Row -->
                      <tr v-if="expandedStudents[student.id]">
                              ...
                              <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                >
                                  ...
                                  <td
                                    ...
                                    :class="getSelisihClass(detail.selisih)"
                                  >
                                    {{ detail.selisih }}
                                  </td>
                                </tr>
              ...
              <div class="mt-6 bg-gray-50 p-4 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                  <div
                    v-for="(range, index) in modalData.ranges"
                    :key="index"
