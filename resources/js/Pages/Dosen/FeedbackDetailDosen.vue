...
const fetchFeedbackSummary = async (forceRegenerate = false) => {
    ...
    try {
        ...
        const response = await fetch(
            `/sispa/api/feedback-summary?${queryParams}`,
            {
                method: "GET",
                headers: {
...
const fetchFeedbacks = async () => {
    try {
        ...
        const response = await fetch(
            `/sispa/api/feedbacks-get-answer?${queryParams}`
        );
...
// Method to format summary text with bold markdown
                            ...
                            <table class="w-full text-left border-collapse">
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td class="p-3">
                                            {{
                                                member.mahasiswa?.user?.name ||
                                                "Tidak Ada"
                                            }}
                                        </td>
                                        <td class="p-3">
                                            {{
                                                member.mahasiswa?.user?.email ||
                                                "Tidak Ada"
                                            }}
                                        </td>
                                        <td class="p-3">
                                ...
                                <div class="p-6">
                                    ...
                                    <div v-else class="text-center py-8">
                                        <p class="text-gray-500">
                                            Belum ada feedback untuk kelompok
                                            ini.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option
                                                ...
                                                :value="student"
                                                :disabled="
                                                    !student.mahasiswa?.id
                                                "
                                            >
                                                {{
                                                    student.mahasiswa?.user
                                                        ?.name || "Tidak Ada"
                                                }}
                                                -
                                                {{
                                    ...
                                    <template v-else>
                                        ...
                                        <div v-else class="space-y-6">
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        class="text-gray-700 whitespace-pre-wrap formatted-summary"
                                                        v-html="
                                                            formatSummaryText(
                                                                summary.summary
                                                            )
