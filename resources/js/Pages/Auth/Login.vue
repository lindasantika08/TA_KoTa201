  ...
  setup() {
    ...
    console.log('Response Login:', response.data);
        ...
        if (response.data.token) {
          ...
          const isFirstLogin = response.data.user.first_login || false;
          const isDefaultPassword = response.data.user.is_default_password || false;
          
          if (isFirstLogin || isDefaultPassword || response.data.need_password_change) {
      ...
      <div class="relative z-10 text-black">
        ...
        <div class="space-y-6">
          <p class="text-sm leading-relaxed text-justify">
            Welcome to Politeknik Negeri Bandung's advanced assessment platform!</p>
          <div class="space-y-4">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
      <div class="w-full max-w-md space-y-8">
        ...
        <div class="text-center">
          <h2 class="text-3xl font-bold text-gray-900">Log In Account</h2>
        ...
        <!-- Error Message -->
        <div v-if="error" 
             class="bg-red-50 text-red-700 p-4 rounded-md flex items-center space-x-2">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <div class="space-y-4">
          <div class="p-4 bg-blue-50 rounded-lg">
            <h4 class="font-medium text-blue-800 mb-2">Dosen (Lecturer)</h4>
          ...
          <div class="p-4 bg-green-50 rounded-lg">
            <h4 class="font-medium text-green-800 mb-2">Mahasiswa (Student)</h4>
