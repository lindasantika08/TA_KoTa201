                ...
                <Card class="shadow-lg">
                    ...
                    <div v-else>
                        ...
                        <div v-if="Object.keys(groupedAnswers).length === 0" class="text-center py-8">
                            ...
                            <p class="mt-4 text-gray-600">Tidak ada data penilaian yang ditemukan.</p>
                        </div>

                        <!-- Assessment Results Section -->
                        <div v-else v-for="(aspectData, aspectName) in groupedAnswers" :key="aspectName"
                            ...
                            <Card class="border-none shadow-none">
                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full">
                                        <thead>
                                            <tr class="bg-gray-50">
                                                <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600 w-16">No
                                                </th>
                                                <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600">
                                                    Pertanyaan</th>
                                                <th class="px-4 py-3 text-center text-sm font-semibold text-gray-600 w-24">
                                                    Skala</th>
                                                <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600">Alasan
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr v-for="(answer, index) in aspectData.answers" :key="index"
