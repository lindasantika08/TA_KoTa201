    ...
    <div class="flex min-h-screen bg-gray-50">
        ...
        <div v-if="showChangePasswordToast"
            ...
            <div class="flex items-center space-x-4">
                <div class="bg-yellow-500 flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-6 md:p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300 cursor-pointer"
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <span
                                        ...
                                        <svg v-if="selfAssessmentStatus" class="w-4 h-4 mr-1.5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path v-if="selfAssessmentStatus === 'Completed'" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                            <path v-else-if="selfAssessmentStatus === 'Pending'" stroke-linecap="round"
                        ...
                        <div class="p-6">
                            <div class="flex items-center space-x-4">
                                <div :class="[
                                    ...
                                    peerGroupSize > 0 && peerCompletedCount === peerGroupSize
                                        ? 'bg-green-100'
                                        : peerCompletedCount > 0
                                            ? 'bg-yellow-100'
                                            : 'bg-gray-100'
                                ...
                                <div class="flex-1">
                                    <div class="flex justify-between items-center mb-1">
                                        ...
                                        <span class="text-sm font-medium text-gray-700">{{ peerCompletedCount }}/{{
                                            peerGroupSize }}</span>
                                    </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="w-full mt-2">
                                        <label for="project-select"
                                            class="block text-sm font-medium text-gray-700 mb-1">Pilih Project:</label>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                            ...
                            <div id="chart-container">
                                <apexchart width="100%" type="radar" :options="radarChartOptions"
                        ...
                        <div class="bg-white rounded-xl shadow-sm overflow-hidden h-full">
                            ...
                            <div class="px-4 pt-4">
                                <div class="border-b border-gray-200">
                                    <nav class="-mb-px flex" aria-label="Tabs">
                                        <button @click="activeTab = 'peer'" :class="[
                                            activeTab === 'peer'
                                        ...
                                        <button @click="activeTab = 'dosen'" :class="[
                                            activeTab === 'dosen'
                                                ? 'border-indigo-500 text-indigo-600'
                                                : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300',
                                            'w-1/2 py-3 px-1 text-center border-b-2 font-medium text-sm',
                            ...
                            <div v-if="activeTab === 'peer'" class="p-4 max-h-64 overflow-y-auto">
                                ...
                                <div v-else-if="feedback?.peerFeedback?.length" class="space-y-3">
                                    <div v-for="(item, index) in feedback.peerFeedback" :key="index"
                            ...
                            <div v-if="activeTab === 'dosen'" class="p-4 max-h-64 overflow-y-auto">
                                ...
                                " class="space-y-3">
                                    <div v-for="(item, index) in feedback.lecturerFeedback" :key="index"
