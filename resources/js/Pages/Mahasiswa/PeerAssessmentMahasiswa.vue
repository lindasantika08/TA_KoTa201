    ...
    methods: {
        async initializeData() {
            ...
            try {
                ...
                const assessment_order = this.$page.props.assessment_order;
            ...
            for (let i = 0; i < retryCount; i++) {
                try {
                    ...
                    this.questions = assessments.map(q => ({
                        ...
                        assessment_order: q.assessment_order,
                        bobot_1: q.bobot_1,
                        bobot_2: q.bobot_2,
                        bobot_3: q.bobot_3,
                        bobot_4: q.bobot_4,
                    ...
                    if (project_details) {
                        ...
                        if (project_details.assessment_order) {
                            this.assessment_order = project_details.assessment_order;
                        }
                    }
                    ...
                    <template v-else>
                        ...
                        <div class="mb-6">
                            ...
                            <select id="select-member" v-model="selectedMember"
                                ...
                                <option v-for="member in availableMembers" :key="member.mahasiswa_id"
                        ...
                        <div v-if="availableMembers.length === 0" class="text-center py-8 bg-gray-50 rounded-lg">
