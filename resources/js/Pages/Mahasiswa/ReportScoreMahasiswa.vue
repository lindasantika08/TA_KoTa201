                ...
                <div v-if="projectScoreDetails && !loading" class="space-y-6">
                    ...
                    <div v-if="activeTab === 'overview'" class="space-y-6">
                        ...
                        <Card class="bg-white">
                            ...
                            <div
                                class="p-4 w-full aspect-square max-w-[1000px] mx-auto"
                            >
                                <VueApexCharts
                                    type="radar"
                                    :height="'100%'"
                            ...
                            <div class="p-6">
                                ...
                                >
                                    <div class="border-b border-gray-200 pb-4">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">
                                            Berikut adalah rangkuman feedback
                                            dari rekan-rekan kelompok Anda
                                        </p>
                                    </div>
                                    ...
                                    <div class="prose max-w-none text-gray-700">
                                        <div class="bg-gray-50 rounded-lg p-6">
                                            ...
                                            >
                                                <svg
                                                    class="w-6 h-6 text-indigo-600 mt-1"
                                                    fill="none"
                                                    stroke="currentColor"
                                                    viewBox="0 0 24 24"
                                                >
                                    ...
                                    <!-- Additional Info -->
                                    <div
                                        class="mt-6 bg-yellow-50 rounded-lg p-4"
                                    >
                                        <div class="flex">
                                            <div class="flex-shrink-0">
                                                <svg
                                            ...
                                            <div class="ml-3">
                                                ...
                                                >
                                                    <p>
                                                        Feedback ini dihasilkan
                                                        berdasarkan penilaian
                                                        dari rekan-rekan
                                                        kelompok Anda. Gunakan
                                                        feedback ini sebagai
                                ...
                                >
                                    <div class="border-b border-gray-200 pb-4">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">
                                            Feedback dan evaluasi dari dosen
                                            pembimbing
                                        </p>
                                    </div>
                                ...
                                <div
                                    v-else-if="
                                        !feedback.aiFeedback &&
                                        (!feedback.lecturerFeedback ||
                                            feedback.lecturerFeedback.length ===
                                                0)
                                    "
                                ...
                                >
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        Feedback akan tersedia setelah rekan
                                        kelompok dan dosen memberikan penilaian.
                                    </p>
                                </div>
                            </div>
                        </Card>
