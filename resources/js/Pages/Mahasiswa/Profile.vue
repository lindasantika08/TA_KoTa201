          ...
          <div class="col-span-4 space-y-4">
            ...
            <Card class="text-center p-6" title="Profile">
              <div class="flex flex-col items-center">
                ...
                <p class="text-gray-600 mb-2">{{ formData.nim }}</p>
                <div class="flex text-gray-500 text-sm">
                  ...
                  {{ formData.prodi }} - {{ formData.jurusan }}
                </div>
              </div>
            </Card>
            ...
            <Card class="p-6">
              ...
              <form @submit.prevent="handleEditSave" class="grid grid-cols-1 gap-4">
                ...
                <div>
                  ...
                  <input v-model="formData.nim" type="text" :class="inputClass" :readonly="!isEditMode" />
                </div>

                <div>
                  <label class="block text-sm font-medium text-gray-700">Prodi</label>
                  <input v-model="formData.prodi" type="text" :class="inputClass" :readonly="!isEditMode" />
                </div>
